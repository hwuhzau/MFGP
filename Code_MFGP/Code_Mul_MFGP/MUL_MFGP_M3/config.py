...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        self.path = get_path(f'../output_3/{args.dataset_y_name}/{args.cor_or_mic}/{args.seed}_{datetime.today().strftime("%Y%m%d_%H_%M_%S")[2:]}')
        self.got_csv = f"../output_3/{args.dataset_y_name}/{args.cor_or_mic}/"
