...
class Config(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--step', type=str, default="mul")
        parser.add_argument('--dataset_x', type=str, default="pro_174_6210_norm.csv")
        ...
        parser.add_argument('--z_tzgc', type=float, default=0, help="设置为0，则表示不进行特征工程")
        ...
        parser.add_argument('--lr', type=float, default=1e-2, help='lr for alpha')
    ...
    def __init__(self):
        ...
        self.path = get_path(f'./output_snp/{args.dataset_y_name}/{args.seed}_{datetime.today().strftime("%Y%m%d_%H_%M_%S")[2:]}')
        self.got_csv = f"./output_snp/{args.dataset_y_name}/"
