...
class Config(BaseConfig):
    def build_parser(self):
        ...
        parser.add_argument('--step', type=str, default="snp")
        ...
        parser.add_argument('--x_tzgc', type=float, default=0.22, help="设置为0，则表示不进行特征工程")
    ...
    def __init__(self):
        ...
        self.path = get_path(f'./output_snp/{args.dataset_y_name}/{args.seed}nvtop')
